...
class data_check:
    def __init__(self,IN_FILE_PATH):
        ...
        CWD = os.path.dirname(IN_FILE_PATH)
        ...
        try:
            ...
            self.result_folder = f'{CWD}/DataCheckResult{timenow}'
            ...
            for file in files:
                ...
                if last_column == 39:
                    ...
                    if sheet_issues != 0:
                        ...
                        new_wb.save(f'{self.result_folder}/{Agency_Name}_Checked_Discrepancies.xlsx')
                        wb.save(f'{self.result_folder}/{Agency_Name}_Checked_General.xlsx')
...
if __name__ == '__main__':
    PATH = 'C:/Users/Qiao Zhang/Desktop/Communities Foundation of Texas/2018Q4/Data Submission'
    data_check(PATH)
